...
<table class="table table-success table-striped table-hover">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$d->toDate}}</td>
      <td>
      <span data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('managers.edit')}}">
        <i class="modalLink bi bi-pencil" data-bs-toggle="modal" data-bs-target="#edit{{$d->id}}"></i>
      </span>  
        <a href="{{url()->current()}}/delete/{{$d->id}}">
          <i class="text-danger bi bi-trash" data-bs-toggle="tooltip" data-bs-placement="left" title="{{__('managers.delete')}}"></i>
        </a>
      </td>
    </tr>
    @endforeach
    <tr>
      ...
      <span data-bs-toggle="tooltip" title="{{__('managers.new')}}">
